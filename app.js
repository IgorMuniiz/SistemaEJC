  ...
  try {
    ...
    equipes.forEach((equipeAtual) => {
      ...
      worksheet.columns = [
        ...
        { header: 'Talento/Habilidade', key: 'talentoHabilidadeArtistica', width: 30 },
        ...
        { header: 'Movimento/Pastoral', key: 'participaMovimentoIgreja', width: 28 },
      ...
      pessoasDisponiveis.forEach((e, idx) => {
        ...
        const rowData = {
          ...
          complementoReferencia: e.complementoReferencia || '',
          bairro: e.bairro || '',
          ...
          talentoHabilidadeArtistica: e.talentoHabilidadeArtistica || '',
          quadroSaude: e.quadroSaude || '',
          medicamentoControlado: e.medicamentoControlado || '',
          religiosidadeAtual: e.religiosidadeAtual || '',
          paroquiaFrequenta: e.paroquiaFrequenta || '',
          participaMovimentoIgreja: e.participaMovimentoIgreja || '',
          email: e.email || '',
